...
$reponse["data"]["les_etats_demandes"] = $taf_config->get_db()->query("select * from etats_demande")->fetchAll(PDO::FETCH_ASSOC);
$reponse["data"]["les_modes_paiements"] = $taf_config->get_db()->query("select * from modes_paiement")->fetchAll(PDO::FETCH_ASSOC);
